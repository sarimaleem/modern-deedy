...
\begin{bullets}
    \item Developed webclient in Java Spring to migrate network element data to CPS database from MongoDB
    ...
    \item Used Java reactive streams to load balance client requests from frontend and ensure requests are nonblocking
\end{bullets}
\sectionsep

\resumeHeading{Baylor College of Medicine}{Research Intern}{Houston, TX}{Jan 2021 - August 2021}
\begin{bullets}
    \item Built computer vision model in C++ to analyze mice pupil dialation size, 50x faster than deep learning model
